...
using S7evemetry.F1_2018.Readers;
...
namespace S7evemetry.F1_2018.Listeners
{
    public class F1_2018Listener : UdpStreamListener,
        ...
        IObservable<PacketData<PacketHeader, SessionData>>
    {
        ...
        public F1_2018Listener(IOptions<UdpListenerSettings> options) : base(options)
        {
