...
using S7evemetry.F1_Legacy.Readers;
...
namespace S7evemetry.F1_Legacy.Listeners
{
    public class F1_LegacyListener : UdpStreamListener,
        ...
        IObservable<PacketData<PacketHeader, SessionData>>
    {
        ...
        public F1_LegacyListener(IOptions<UdpListenerSettings> options) : base(options)
        {
